...
<head>
    ...
    <title>Pagina Posiciones</title>
</head>
<body>
    <form action="paginaPosicion.php" method="POST">
    <h1>Posicion de los jugadores</h1>
    <table>
        <tr>
            <td>Juega de: </td>
        </tr>
        <?php
            ...
            $sql="SELECT Posicion FROM `posicion` WHERE (IdPosicion = $conta)";
